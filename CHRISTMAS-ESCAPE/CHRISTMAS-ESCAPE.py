...
#fond
fond1= ["images/salon.png",False]
fond2= ["images/cuisine.jpg",False]
fond3=["images/chambre-enfant.jpg",False]
chambre_enfant2 = image.load("images/chambre-enfant2.jpg").convert_alpha()
chambre_enfant3 = image.load("images/chambre-enfant3.jpg").convert_alpha()
fond4 = ["images/chambre.jpg",False]
chambre2 = image.load("images/chambre2.jpg").convert_alpha()
chambre3 = image.load("images/chambre3.jpg").convert_alpha()

fenetre2= Fenetre('hk',0,False)

#porte
porte1=Porte(["images/porteouverte.png","images/porteferme.png"],False,760,160)
porte2= Porte(["images/cuisine.jpg","images/cuisine.jpg"],False,0,0)
porte3= Porte(["images/longueporteouverte.png","images/longueportefermee.png"],False,798,133)
porte4= Porte(["images/grandeporteouverte.png","images/grandeportefermee.png"],False,0,48)
...
papanoel=[[0,360],image.load("images/pere.png").convert_alpha()]

#dialogue perenoel
dialogue=image.load("images/dialogue.png").convert_alpha()
dialogue2=image.load("images/dialogue2.png").convert_alpha()
noir=(0,0,0)
...
air=police.render("Un courant d'air a fait tomber quelque chose ailleurs",1,noir)
vent= image.load("images/vent.png").convert_alpha()
#menu du debut
menu = image.load("images/menu.png").convert_alpha()
fenetre.blit(menu,(0,0))
display.flip()
musique=mixer.music.load("sons/musique.mp3" )
mixer.music.play( )
debut=1
a=1
x=0
        ...
        if salle1.fond[1] == True:
            ...
            if x==1 or x==2:
                ...
                while papanoel[0][0]<800 :
                    ...
                    if papanoel[0][0]>=800 :
                        salle1.afficher()
                        papanoel[1]=image.load("images/pere.png").convert_alpha()
                        fenetre.blit(papanoel[1],(papanoel[0]))
...
##                    display.flip()
            if scenar<2:
                ...
                fenetre.blit(cadena2,(papanoel[0][0]+365,papanoel[0][1]+90))
                display.flip()
            if scenar== 2:
                fenetre.blit(dialogue2,(papanoel[0][0]+300,papanoel[0][1]+40))
                fenetre.blit(cadena,(papanoel[0][0]+363,papanoel[0][1]+65))
            ...
            if scenar ==3 :
                fenetre.blit(dialogue2,(papanoel[0][0]+300,papanoel[0][1]+40))
                fenetre.blit(etroit,(papanoel[0][0]+363,papanoel[0][1]+65))
                fenetre.blit(etroite,(papanoel[0][0]+363,papanoel[0][1]+90))
                fenetre.blit(air,(200,300))
                fenetre.blit(vent,(30,400))
                display.flip()
            ...
            if  event.type == MOUSEBUTTONDOWN  :
                ...
                if scenar==2 and 27<= pointclic[0] <= 49  and 206<= pointclic[1] <= 258:
                    salle2.fond[0]='images/cuisine2.jpg'
                    salle2.afficher()
                    fenetre.blit(papanoel[1],(papanoel[0]))
                    display.flip()
                    scenar=3
                if scenar==3 and 825<=pointclic[0]<=860 and 250<=pointclic[1]<=350:
                    salle2.fond[0]='images/cuisine3.jpg'
                    salle2.afficher()
                    papanoel[1]=image.load("images/pere2.png").convert_alpha()
                    fenetre.blit(papanoel[1],(papanoel[0]))
                    display.flip()
        ...
        if salle3.fond[1]==True:
                        ...
                        if event.type == MOUSEBUTTONDOWN :
                            ...
                            if scenar==1 and 348>=pointclic[1] >=306  and 210 <=pointclic[0] <= 248:
                                salle3.fond[0]="images/chambre-enfant2.jpg"
                                salle3.afficher()
                                fenetre.blit(papanoel[1],(papanoel[0]))
                            ...
                            if scenar==2 and pointclic[1] >=306 and pointclic[1] <= 348 and pointclic[0] >= 210 and pointclic[0] <= 248:
                                salle3.fond[0]="images/chambre-enfant3.jpg"
                                salle3.afficher()
                                fenetre.blit(papanoel[1],(papanoel[0]))
                                display.flip()
        ...
        if salle4.fond[1]==True:
            ...
            if scenar==0 and salle4.porte.ouverture==False:
                ...
                display.flip()
            if scenar==3:
                salle4.fond[0]="images/chambre_cle.jpg"
                salle4.afficher()
                fenetre.blit(papanoel[1],(papanoel[0]))
                display.flip()
            ...
            if event.type == MOUSEBUTTONDOWN  :
                ...
                if pointclic[1] >=350 and pointclic[1] <= 387 and pointclic[0] >= 248 and pointclic[0] <= 325 and scenar==0:
                    salle4.fond[0]="images/chambre2.jpg"
                    salle4.afficher()
                    fenetre.blit(papanoel[1],(papanoel[0]))
                    fenetre.blit(dialogue,(papanoel[0][0]-350,papanoel[0][1]+40))
                    ...
                    display.flip()
                    time.wait(1000)
                    salle4.fond[0]="images/chambre3.jpg"
                    salle4.afficher()
                    scenar=1.1
                ...
                if 220 <= pointclic[1] <= 265 and 550 <= pointclic[0] <= 600 and scenar==3:
                    salle4.fond[0]="images/chambre4.jpg"
                    salle4.afficher()
                    fenetre.blit(papanoel[1],(papanoel[0]))
                    display.flip()
                    scenar=3.5
...
##salle=[0,salle1,salle2,salle3,salle4]
##for i in range (1,5):
##                if salle[i].fond[1]== True:
##                    for j in range (len(salle[i].passage)-1):
##                        if salle[i].passage[j].xmin <= pointclic[0] <= salle[i].passage[j].xmax  and salle[i].passage[j].ymin <= pointclic[1] <= salle[i].passage[j].ymax:
##                            salle[i].passage[j].passer()
##                    p = pygame.transform.scale(papanoel[1], (papanoel[0][0]-40, papanoel[0][1]-40))
##                    fenetre.blit(p,(papanoel[0]))
##
##                    print(papanoel[1].get_rect())